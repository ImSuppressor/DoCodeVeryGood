...
@Autonomous(name="12Wdump", preselectTeleOp = "LeagueDrive")
public class twelvewithDump extends LinearOpMode {
...
//                .stopAndAdd(new SetvelforMotor(outakeR,20))
                ...
                .afterTime(1.1,new SetpositionforMotor(turret,-750))
        ...
        Action Grab2 = drive.actionBuilder(new Pose2d(35,12.5,0))
                .stopAndAdd(new SetpowerforMotor(intake, 1))
                .strafeToLinearHeading(new Vector2d(70,12.5),Math.toRadians(0),
        ...
        Action backup = drive.actionBuilder(new Pose2d(70,12.5,0))
                .strafeToLinearHeading(new Vector2d(55,12.5),Math.toRadians(0))
                .build();
        Action dump = drive.actionBuilder(new Pose2d(55,12.5,0))
                .strafeToLinearHeading(new Vector2d(71,2),Math.toRadians(0))
                .waitSeconds(.25)
                .build();
        Action backupDUmp = drive.actionBuilder(new Pose2d(71,2,0))
                .strafeToLinearHeading(new Vector2d(45,2),Math.toRadians(0))
                .build();
        Action Score2 = drive.actionBuilder(new Pose2d(45,2,0))
        ...
        Action failsafe_thang = drive.actionBuilder(new Pose2d(24,-24,-45))
                .afterTime(.01,new twelvewithDump.Setpositionforservo(Boot1,.5))
                .afterTime(.3,new twelvewithDump.Setpositionforservo(Boot1,.94))
                .afterTime(.8,new twelvewithDump.Setpositionforservo(Boot2,.5))
                .afterTime(1,new twelvewithDump.Setpositionforservo(Boot2,.94))
                .afterTime(1.5,new twelvewithDump.Setpositionforservo(Boot3,.5))
                .afterTime(1.8,new twelvewithDump.Setpositionforservo(Boot3,.94))
